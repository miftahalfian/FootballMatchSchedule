...
import com.solitelab.footballmatchschedule.mvp.search.SearchPresenter
...
class SearchActivity : AppCompatActivity(), com.solitelab.footballmatchschedule.mvp.search.SearchView {
    ...
    fun goToResult(match:Match, homeLogo:ImageView, awayLogo:ImageView, homeSrc:String, awaySrc:String) {
